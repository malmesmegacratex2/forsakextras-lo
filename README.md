...
```lua
loadstring(game:HttpGet("https://github.com/malmesmegacratex2/forsakextras-lo/releases"))()
```
...
>
> **If you like this script, consider [starring the repo](https://github.com/malmesmegacratex2/forsakextras-lo/releases) or sharing it around (with proper credit, please!)** — it helps a lot!
